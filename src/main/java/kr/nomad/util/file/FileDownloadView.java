...
public class FileDownloadView extends AbstractView {
	...
	protected void PdfDownloadOutputModel(Map model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		// Controller에서 넘어온 파일 정보를 추출한다
		// 여기서 Map인 model객체는 Controller에서 ModelAndView객체에 addObject하여 넘어온 정보다.
	    String filename = "2015-07-21";
	    String filename2 = new String(filename.getBytes("UTF-8"),"UTF-8");

	    response.setContentType("application/octet-stream");
	    File file = new File ("D:/00_FILE_DATA/QrayCam/files/imagefile"+filename);
