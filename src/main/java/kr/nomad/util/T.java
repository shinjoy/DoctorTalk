...
public class T {
	...
	public static String getMonth() {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(new Date(System.currentTimeMillis()));
		String today = new SimpleDateFormat("yyyy-MM").format(calendar.getTime());	//"yyyyMMDD"
		return today;
	}
	
	//날짜 요일 구하기
	public static int daytype(String date){
		Calendar calendar = Calendar.getInstance();
		calendar.set(Calendar.YEAR, Integer.parseInt(date.substring(0, 4)));
	...
	//몇주차인지 반환 
	public static String getWeekInMonth(String yyyymmdd) {
		...
		String weekInMonth = new SimpleDateFormat("W").format(calendar.getTime());	//"W"
		return weekInMonth;
	}
	...
	public static String getNowFomat2() {
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(new Date(System.currentTimeMillis()));
		String now = new SimpleDateFormat("aa:hh:mm").format(calendar.getTime());	//"yyyyMMDDHHmmss"
		return now;
	}
	...
	public static int getDateminus(String date1, String date2) {
		...
		long sec = ((calendar1.getTimeInMillis()-calendar2.getTimeInMillis()))/1000;
	...
	public static String[] getFirstAndFinishDayOfMonth(String date) {
