...
<script type="text/javascript">
	...
	function searchList(searForm,page) {
		...
		document.location.href = "/pc/weight_view.go?userId="+searForm.seaId.value+"&page="+page;
		...
		<section id="contents">
			...
			<div class="contents-block">
				...
				<div class="tab-bar">
					...
					<button type="button" class="tab active" onclick="document.location.href='/pc/weight_view.go?userId=${user.userId}';"><span>체중</span></button>
				...
				<div class="tbl-list">
					...
					<button class="btn" onclick="windowOpen('/pc/grape.go?userId=${user.userId}&diseaseId=weight','Recover',900,480,'yes','no');" style="margin-top:10px;">그래프 보기</button>
