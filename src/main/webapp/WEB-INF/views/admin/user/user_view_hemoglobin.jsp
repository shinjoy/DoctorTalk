...
<%-- 					<button type="button" class="btn-blue" onclick="document.location.href='/admin/user/user_edit.go?userId=${user.userId}';">수정</button> --%>
				...
				<div class="tab-bar">
					...
					<button type="button" class="tab active" onclick="document.location.href='/admin/user/user_view_hemoglobin.go?userId=${user.userId}';"><span>당화혈색소</span></button>
				...
				<div class="tbl-list">
					...
					<br>
					<iframe name="graph" src="/m/grape_do.go?userId=${user.userId}&diseaseId=hba&speriod=${before}&eperiod=${today}" style="border:0; width:990px; height:280px;"></iframe>
