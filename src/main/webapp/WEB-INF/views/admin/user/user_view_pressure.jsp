...
<%-- 					<button type="button" class="btn-blue" onclick="document.location.href='/admin/user/user_edit.go?userId=${user.userId}';">수정</button> --%>
				...
				<div class="tab-bar">
					...
					<button type="button" class="tab active" onclick="document.location.href='/admin/user/user_view_pressure.go?userId=${user.userId}';"><span>혈압</span></button>
				...
				<table class="register" style="margin-top:10px;">
					...
					<br>
					<iframe name="graph" src="/m/grape_do.go?userId=${user.userId}&diseaseId=pressure&speriod=${before}&eperiod=${today}" style="border:0; width:990px; height:280px;"></iframe>
