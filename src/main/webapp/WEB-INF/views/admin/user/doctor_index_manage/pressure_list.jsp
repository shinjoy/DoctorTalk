...
function deleteNotice(comSeq) {
	if(confirm("삭제하시겠습니까?")) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/doctor_index_manage/blood_delete_do.go",
			dataType:"json",
			data:param,
				...
				<c:forEach var="it" items="${list}">
					<li class="ui-state-default" >
						...
						<span class="ui-icon ui-icon-arrowthick-2-n-s"></span>
							...
							<input type="checkbox" name="isLast" value="${it.comSeq}" style="margin-left:3px;">
							<span style="display:inline-block; width:8px;  text-align:center">${it.comSeq}</span>
