...
<script type="text/javascript">
	...
	function searchList(listForm,page) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/analysis/empty_morning_list.go",
			dataType:"html",
			data:param,
	...
	function addListForm(frm) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/analysis/empty_morning_edit_do.go",
			dataType:"json",
			data:param,
	...
	function ListEditForm(frm) {
		...
		var imgType = $("select[class=imgType]").val(); 
		...
		$.ajax({
			type:"POST",
			url:"/admin/analysis/empty_morning_edit_table_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
