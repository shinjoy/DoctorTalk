...
<section class="main-cover">
	<header id="top-header">
		<aside>
			<div class="top-logo">
				<a href="/admin/main.go"><div style="height:40px;font-weight:bold;font-size:20px;color:#fff;">Recover</div></a>
				<!-- 
				<a href="/admin/main.go"><img src="/images/Untitled-1.png"></a>
				 -->
			</div>
		</aside>
		<section>
