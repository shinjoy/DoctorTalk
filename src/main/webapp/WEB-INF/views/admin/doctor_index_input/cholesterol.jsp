...
<script type="text/javascript">
	...
	function searchList(listForm,page) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/doctor_index_input/cholesterol_list.go",
			dataType:"html",
			data:param,
	...
	function addListForm(frm) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/doctor_index_input/cholesterol_edit_do.go",
			dataType:"json",
			data:param,
	...
	function ListEditForm(frm) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/doctor_index_input/cholesterol_edit_table_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
...
*/	
		...
		$.ajax({
			type:"POST",
			url:"/admin/cholesterol/sort_edit_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
