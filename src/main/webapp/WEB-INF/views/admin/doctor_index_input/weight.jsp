...
function addListForm(frm) {
	...
	function answerListForm(frm) {
		...
		var param = {
			diseaseId : frm.diseaseId1.value,
			comSeq  : frm.comSeq.value,
 			askind	: frm.askind.value,
	...
	*/	
			...
			$.ajax({
				type:"POST",
				url:"/admin/weight/sort_edit_do.go",
				dataType:"json",
				data:param,
				success:function(json){
					alert(json.message);
...
<!-- 									<button type="submit" class="btn" >검색</button> -->
					...
					<div style="text-align:right; margin-top:10px; margin-right:10px;">
						<button type="button"  class="btn" onclick="checkQuestion(this.form)">질문 체크</button>
						...
						<div style="margin-top:20px;">
							...
							<form method="post" name="addForm" id="addForm" >
								...
								<div class="guide" id="guide" style="display:block; margin-bottom:10px;" >
									...
									<input type="text" name="diseaseId" class="itext" placeholder="질병이름" >
									 <input type="text" class="itext"  name="comment" style="width:700px;  margin:5px 5px 5px 10px;">
