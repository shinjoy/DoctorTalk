...
<script type="text/javascript">
	...
	function searchList(listForm,page) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/doctor_index_manage/cholesterol_list.go",
			dataType:"html",
			data:param,
...
<!-- 								<div class="guide" id="guide" style="display:block; " > -->
<!-- 									 <input type="text" class="itext"  name="comment" style="width:300px;"> -->
<!-- 									 <button class="btn" type="button" onclick="addListForm(this.form)">등록</button> -->
<!-- 								</div> -->
...
<!-- 										<option value="1">선택</option>	 -->
<!-- 									</select>  -->
<!-- 								 	 <input type="text" class="itext"  name="comment1" style="width:300px;"> -->
<!-- 									 <button class="btn" type="button" onclick="answerListForm(this.form)">등록</button> -->
<!-- 								 </div> -->
<!-- 							</form> -->
<!-- 						</div> -->
