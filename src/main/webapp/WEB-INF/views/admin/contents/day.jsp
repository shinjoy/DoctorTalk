...
<script type="text/javascript">
	...
	function searchList(listForm,page) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/contents/day_list.go",
			dataType:"html",
			data:param,
	...
	function addListForm(frm) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/contents/day_edit_do.go",
			dataType:"json",
			data:param,
	...
	function ListEditForm(frm) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/contents/day_edit_table_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
	...
	function checkQuestion() {
		...
		$.ajax({
			type:"POST",
			url:"/admin/day/day_checkQuest_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
