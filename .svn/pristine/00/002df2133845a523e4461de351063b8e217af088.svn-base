				...
				<input type="hidden" name="userName" value="${USER_NAME}"/>
					...
					<div class="contents-edit">
						...
						<tr>
							<th>년월</th>
							<td>
								<input type="text" name="year" class="itext" value="${fn:substring(magazine.month,0,4)}" style="width:50px;">년
								<select name="month">
									<option value="01"${fn:substring(magazine.month,5,7) =='01' ? 'selected="true"' : '' }>01</option>
									<option value="02" ${fn:substring(magazine.month,5,7)=='02' ? 'selected="true"' : '' }>02</option>
									<option value="03" ${fn:substring(magazine.month,5,7)=='03' ? 'selected="true"' : '' }>03</option>
									<option value="04" ${fn:substring(magazine.month,5,7)=='04' ? 'selected="true"' : '' }>04</option>
									<option value="05" ${fn:substring(magazine.month,5,7)=='05' ? 'selected="true"' : '' }>05</option>
									<option value="06" ${fn:substring(magazine.month,5,7)=='06' ? 'selected="true"' : '' }>06</option>
									<option value="07" ${fn:substring(magazine.month,5,7)=='07' ? 'selected="true"' : '' }>07</option>
									<option value="08" ${fn:substring(magazine.month,5,7)=='08' ? 'selected="true"' : '' }>08</option>
									<option value="09" ${fn:substring(magazine.month,5,7)=='09' ? 'selected="true"' : '' }>09</option>
									<option value="10" ${fn:substring(magazine.month,5,7)=='10' ? 'selected="true"' : '' }>10</option>
									<option value="11" ${fn:substring(magazine.month,5,7)=='11' ? 'selected="true"' : '' }>11</option>
									<option value="12" ${fn:substring(magazine.month,5,7)=='12' ? 'selected="true"' : '' }>12</option>
								</select>월
							</td>
						</tr>
						<tr>
