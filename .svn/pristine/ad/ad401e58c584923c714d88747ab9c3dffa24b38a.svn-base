...
function excelDownload() {
	var frm = listForm;
	document.location.href = "/admin/user/counselor_list_excel.go";
}
					...
					<form method="post" name="listForm" id="listForm" onsubmit="return searchList(this,1); return false;">
						<div class="contents-top">
							<div class="top-tools">
								...
								<div class="btn-tools"><button class="btn-blue" onclick="location.href='/admin/user/admin_edit.go?userId='" >상담원 등록</button></div>
