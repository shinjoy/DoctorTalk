...
<script type="text/javascript">
	...
	function searchList(listForm,page) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/contents/week_list.go",
			dataType:"html",
			data:param,
	...
	function addListForm(frm) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/contents/week_edit_do.go",
			dataType:"json",
			data:param,
	...
	function ListEditForm(frm) {
		...
		$.ajax({
			type:"POST",
			url:"/admin/contents/week_edit_table_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
	...
	function checkQuestion() {
		...
		$.ajax({
			type:"POST",
			url:"/admin/week/week_checkQuest_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
...
*/	
		...
		$.ajax({
			type:"POST",
			url:"/admin/week/sort_edit_do.go",
			dataType:"json",
			data:param,
			success:function(json){
				alert(json.message);
					...
					<form method="post" name="listForm" id="listForm" onsubmit="return searchList(this,1); return false;">
						...
						<div style="margin-top:20px;">
							...
							<form method="post" name="addForm" id="addForm" >
								<input type="hidden" name="weekSeq"  value="0">
