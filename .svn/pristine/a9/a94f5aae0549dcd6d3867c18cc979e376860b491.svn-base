...
<%-- 					<button type="button" class="btn-blue" onclick="document.location.href='/admin/user/user_edit.go?userId=${user.userId}';">수정</button> --%>
				...
				<div class="tab-bar">
					...
					<button type="button" class="tab active" onclick="document.location.href='/admin/user/user_view_week.go?userId=${user.userId}';"><span>관리주기</span></button>
				...
				<table class="register" style="margin-top:10px;">
						<thead>
							<th style="text-align:center;">혈당 주기</th>
							<th style="text-align:center;">혈압 주기</th>
							<th style="text-align:center;">체중 주기</th>
							<th style="text-align:center;">등록일자</th>
						</thead>
						<tbody>
							<tr class="center">
								<td>${Usercnt.bcntText}</td>
								<td>${Usercnt.pcntText}</td>
								<td>${Usercnt.wcntText}</td>
								<td>${fn:substring(Usercnt.regDate,0,16)}</td>
							</tr>
						</tbody>
					</table>
