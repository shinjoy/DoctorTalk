...
<script type="text/javascript">
	...
	function searchList(searForm,page) {
		...
		document.location.href = "/pc/hemoglobin_view.go?userId="+searForm.seaId.value+"&page="+page;
		...
		<section id="contents">
			...
			<div class="contents-block">
				...
				<div class="tab-bar">
					...
					<button type="button" class="tab active" onclick="document.location.href='/pc/hospital_view.go?userId=${user.userId}';"><span>병원 목록</span></button>					
				</div>
				...
				<div>
					<form method="post" name="firmForm" onsubmit="return submitForm(this); return false;">
						...
						<table class="usertext" style="margin-top:30px; width:100%;">
							...
							<tbody>
								<tr>
									<td> <input type="text" class="itext" style="width:40px;" name="haveHistory" value="${userBasic.haveHistory}">  </td>
									<td> <input type="text" class="itext" style="width:30px;" name="familyHistory" value="${userBasic.familyHistory}" >  </td>
									<td> <input type="text" class="itext" style="width:40px;" name="drugHistory" value="${userBasic.drugHistory}">   </td>
									<td> <input type="text" class="itext" style="width:30px;" name="oralKind" value="${userBasic.oralKind}">    </td>
									<td> <input type="text" class="itext" style="width:30px;" name="oralAmount" value="${userBasic.oralAmount}"> </td>
									<td> <input type="text" class="itext" style="width:30px;" name="oralUse" value="${userBasic.oralUse}"> </td>
									<td> <input type="text" class="itext" style="width:30px;" name="insulinKind" value="${userBasic.insulinKind}"> </td>
									<td> <input type="text" class="itext" style="width:30px;" name="insulinAmount" value="${userBasic.insulinAmount}">   </td>
									<td> <input type="text" class="itext" style="width:30px;" name="insulinUse" value="${userBasic.insulinUse}"> </td>
								</tr>
							</tbody>
						</table>
						<div  class="btn-tools" >	
